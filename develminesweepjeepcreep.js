...
var gameboarddatabox = document.getElementById('gameboarddata');
var tempgameboarddata = gameboarddatabox.textContent.trim().split(" ");
...
var charsetbox = document.getElementById('charset');
var tempcharset = charsetbox.textContent.trim().split(" ");
...
var resetbackgroundcolor = resetbutton.style.backgroundColor;
var resettextcolor = resetbutton.style.color;
var gametitle = document.getElementById('gametitle');
var titlecolor = gametitle.style.backgroundColor;
var titletextcolor = gametitle.style.color;
...
/*		texturedgamepieces[i].style.top = "-"+gamepieces[i].style.padding;
		var textureoffset =
				parseInt(
					gamepieces[i].style.height.substring(
						0,
						parseInt(
							gamepieces[i].style.height.length
						)
						-2
					)
				);
		if(i==0){alert(textureoffset);}
		textureoffset =
				parseInt(
					textureoffset
				)+
				2*(
					parseInt(
						gamepieces[i].style.padding.substring(
							0,
							parseInt(
								gamepieces[i].style.padding.length
							)
							-2
						)
					)-2
					-parseInt(
						gamepieces[i].style.borderWidth.substring(
							0,
							parseInt(
								gamepieces[i].style.borderWidth.length
							)
							-2
						)
					)
				);
		if(i==0){alert(textureoffset+" padding"+gamepieces[i].style.padding+" borderwidth"+gamepieces[i].style.borderWidth);}
*/
...
lockdown=0
var lockedelements = document.getElementsByClassName('disabled');
